...
const PartnershipsReviewSection = () => {
    return (
        <div className={styles.partnershipsReviewSection}>
            <div className={` ${styles.partnershipsReviewContent} container `}>
                <div className="row">
                    <div className={`${styles.partnershipsReviewDiv} col`}>
                        <div className="row">
                            <div className="col-4">
                                <div className={styles.reviewImg}>
                                    <img src="/homeImages/person4.png" alt="Customers" />
                                </div>
                            </div>
                            <div className={`${styles.reviewText} col-8`}>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis quis cupiditate quidem placeat ducimus vitae.</p>
                                <h5>
                                    - Emily R.
                    ...
                    <div className={`${styles.partnershipsReviewCol} col`}>
                        <div className={styles.scrollableContainer}>
                            <div className={`${styles.reviewContent} row`}>
                                <div className="col-4">
                                    <div className={styles.reviewImg}>
                                        <img src="/homeImages/person5.png" alt="Customers" />
                                    </div>
                                </div>
                                <div className={`${styles.reviewText} col-8`}>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis quis cupiditate quidem placeat ducimus vitae.</p>
                            ...
                            <div className={`${styles.reviewContent} row`}>
                                <div className="col-4">
                                    <div className={styles.reviewImg}>
                                        <img src="/homeImages/person6.png" alt="Customers" />
                                    </div>
                                </div>
                                <div className={`${styles.reviewText} col-8`}>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis quis cupiditate quidem placeat ducimus vitae.</p>
...
export default PartnershipsReviewSection;